...
public class Window extends JFrame implements ActionListener {
	...
	public void setLabelText(int gen, int fitness) {
		...
		String s = "Generation: " + Integer.toString(gen) + "   " + "Highest fitness: "
				+ Integer.toString(storedFitness) + "    Max Fitness: "
				+ Integer.toString(canvas.getSolution().getMaxFitness());
	...
	public void actionPerformed(ActionEvent event) {
		if (event.getActionCommand().equals("start")) {
			...
			try {
				...
				setNonogram(Main.nonogramFromFile(chooser.getSelectedFile().getAbsolutePath()));
